...
class MailParser extends Transform {
    ...
    createNode(node) {
        ...
        if (!/^multipart\//i.test(contentType)) {
            if (disposition && (newNode.filename || !['attachment', 'inline'].includes(disposition))) {
            ...
            console.log('EMAIL NODE', contentType, disposition, contentType, newNode.isAttachment, newNode);
